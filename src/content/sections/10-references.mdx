...
- [Redux Store subscriptions](https://redux.js.org/faq/store-setup/#how-do-i-subscribe-to-only-a-portion-of-the-state-can-i-get-the-dispatched-action-as-part-of-the-subscription)
